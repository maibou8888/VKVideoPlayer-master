...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if ([viewController isKindOfClass:[VKVideoPlayerViewController class]]) {
    ...
    [videoController playVideoWithStreamURL:[NSURL URLWithString:@"http://movies.apple.com/media/us/iphone/2010/tours/apple-iphone4-design_video-us-20100607_848x480.mov"]];
